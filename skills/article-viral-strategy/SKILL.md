...
`article` 流水线已经能产出**高质量、合规、去 AI 味、SEO 友好、视觉规范**的文章。但"高质量" ≠ "有人看、有人转"。
...
所以本 skill 的所有手法都在合规边界内运作。**合规与爆款同向**，这不是妥协，而是 2025+ 唯一可持续的爆款路径。营销表达由 `content-writing` 的确定性扫描器检查，模型不得读取完整敏感词库。
