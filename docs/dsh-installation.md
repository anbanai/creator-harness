...
## 4.1.18 release-operator checklist
...
`file:/absolute/path/anban-dsh-plugin-4.1.18.tgz`; a `file:` directory and an
...
```bash
pnpm pack --json
PACKED_TARBALL="/absolute/path/anban-dsh-plugin-4.1.18.tgz"
